...
int main(int argc, char *argv[]) {
    if (argc < 4) {
        ...
        cerr << "example usage: ./scdbg 32 100 0 input_file output_file" << endl;
        exit(1);
    }
    ...
    // string dna_str1 = "GACTTACAGATC";
    // string dna_str2 = "GACTGACATC";
    // string dna_str3 = "CGATCATC";
    //
    // // result:
    // // TCCGTGGGACTAAA$C
    // //  001111110111111    <-- B_F
